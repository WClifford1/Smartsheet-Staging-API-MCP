...
export class MCPService {
   ...
   */
  private async getDogDescription(parameters: any): Promise<MCPToolResult> {
   ...
   */
  private async getDogCareTips(parameters: any): Promise<MCPToolResult> {
   ...
   */
  private async getBreedMatch(parameters: any): Promise<MCPToolResult> {
